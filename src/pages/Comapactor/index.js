    ...
    return (
        <div className={`${styles.Main}`}>
            <div className={`${styles.Forge}`}>
                        <h2>The Forge</h2>
                <img className={styles.img_preview_upload} src={button} onClick={() => previewUploaderRef.current.click()}/>
                <img className={styles.img_layout_upload} src={button1} onClick={() => layoutUploaderRef.current.click()}/>
                <span>Upload Two of your GOATZ</span> <br/> <span>and create a preview of your Forged GOAT</span>
                        <div>
                            <div>
            ...
            <div>
                        <div className={styles.container} >
                            ...
                            <div>
                                ...
                                {
                                    background ? <img className={styles.background} src={background}/> : null
                                }
                                {
                ...
                <div>
                            ...
                            <div className={styles.options}>
                                ...
                                <div>
                                    ...
                                    <button className={styles.icon} onClick={stateReset}><FontAwesomeIcon icon={faTrashAlt}/></button>
                                </div>
                            </div>
                        </div>
        </div>
